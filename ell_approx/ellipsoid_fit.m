...
function [ center, radii, evecs, v, volume ] = ellipsoid_fit( X, volVX, sXc, sYc, sZc)%, flag, equals )
flag = 0;
...
%     [volume volVX volume/volVX]
    ...
    if (volVX/volume > crit || volume/volVX > crit)
        %redo as sphere with given centroid and volume ( same as spherical
        %approximation)
